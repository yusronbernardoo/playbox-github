    ...
    <div className="min-h-screen bg-playbox-bg text-playbox-text-primary font-sans relative overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-lg mx-auto p-4 space-y-5 pb-8">
        ...
        <div className="pt-10 pb-4 text-center border-t border-white/5 mt-8">
          ...
          <a href="https://renterva.web.id" target="_blank" rel="noopener noreferrer" className="inline-block hover:scale-105 transition-transform">
            <img src="/renterva-logo.png" alt="Renterva Play" className="h-14 object-contain opacity-80 hover:opacity-100 transition-opacity drop-shadow-[0_0_10px_rgba(37,99,235,0.3)]" />
          </a>
        </div>
      </main>
